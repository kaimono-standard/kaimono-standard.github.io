...
export const OFFICIAL_SHOPS = ["panasonic-store", "siroca", "braunhousehold", "bruno-official", "tiger-online", "tiger-official-store", "irisplaza-r", "bellevie-harima", "twinbird", "zojirushi-direct", "thermos-shop", "delonghi", "fujisangyo", "brewmatic-jura", "anker", "machinoomise", "ugreen-gear", "belkin-shop", "elecom", "samsonite", "ace-store", "mujirushi-ryohin", "373shinshu", "kojima-ya", "pokkasapporo", "hario-onlinestore", "asvel", "pfudirect", "realforce", "logicool", "keychron", "koizumi-onlineshop", "x-plosion", "realstyle4u", "calinuts", "toyotomi-homeplus", "yamazenkaden", "e-baby", "karcher"];
